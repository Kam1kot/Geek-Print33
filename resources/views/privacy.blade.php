        ...
        <div class="p-3 d-flex justify-content-center flex-column gap-3">
            <section class="content-wrapper">
                <div class="text-center">
                    <h2 class="fs-2 fw-medium mb-3s">Политика Конфиденциальности</h2>
                </div>
                <div class="content-inner">
                    <div class="row mb-3">
                        <div class="col" style="border: solid 2px #ff6a00; padding: 20px">
                            <div id="inputResult">
                                <div class="row mb-4">
                                    <div class="col">
                                ...
                                <div class="row mb-4">
                                    <div class="col">
                                        ...
                                        <div class="descr">
                                            ...
                                            данных, предпринимаемые <span class="link mark owner-name-field" id="owner-name-value" data-scroll-to="#owner-name-field">Васильевым Романом Александрович</span> (далее&nbsp;— Оператор).
                                        </div>
                                        <div class="ol">
                                            <div class="li">
                                            ...
                                            <div class="li">
                                                ...
                                                которую Оператор может получить о&nbsp;посетителях веб-сайта <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://geek-print33.ru</span>.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="ol">
                                            ...
                                            <div class="li">
                                                ...
                                                их&nbsp;доступность в&nbsp;сети интернет по&nbsp;сетевому адресу <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://geek-print33.ru</span>.
                                            </div>
                                            <div class="li">
                                            ...
                                            <div class="li">2.8. Персональные данные&nbsp;— любая информация,
                                                ...
                                                Пользователю веб-сайта <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://geek-print33.ru</span>.
                                            </div>
                                            <div class="li">
                                            ...
                                            <div class="li">
                                                2.10. Пользователь&nbsp;— любой посетитель веб-сайта <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://geek-print33.ru</span>.
                                            </div>
                                            <div class="li">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="ol">
                                            ...
                                            <div class="li">
                                                ...
                                                Оператору уведомление на&nbsp;адрес электронной почты Оператора <span class="link mark owner-email-field" data-scroll-to="#owner-email-field">Geek-print33@yandex.ru</span>
                                            ...
                                            <div class="li">
                                                ...
                                                посредством электронной почты на&nbsp;электронный адрес Оператора <span class="link mark owner-email-field" data-scroll-to="#owner-email-field">Geek-print33@yandex.ru</span>
                                            ...
                                            <div class="li">
                                                8.10. Для анализа посещаемости сайта Оператор использует сервис веб-аналитики
                                                Яндекс.Метрика, предоставляемый ООО «ЯНДЕКС» (Россия). <br>

                                                Яндекс.Метрика использует cookie-файлы и иные технологии, позволяющие
                                                анализировать активность Пользователей на сайте. Полученная информация
                                                используется исключительно для составления статистических отчетов
                                                и улучшения работы сайта. <br>

                                                Оператор не передает в Яндекс.Метрику персональные данные Пользователей,
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="ol">
                                            <div class="li">
                                                ...
                                                к&nbsp;Оператору с&nbsp;помощью электронной почты <span class="link mark owner-email-field" data-scroll-to="#owner-email-field">Geek-print33@yandex.ru</span>.
                                            </div>
                                            <div class="li">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="ol">
                                            <div class="li">
                                                ...
                                                (обязательные cookie), а также аналитические cookie для сбора обезличенной
                                                статистики посещений сайта.
                                            </div>
                                            <div class="li">
                                                13.2. Обязательные cookie обеспечивают работу корзины, сессий и защиты форм.
                                                Аналитические cookie используются исключительно для анализа посещаемости
                                                сайта и улучшения его работы и не используются для идентификации пользователя.
                                            </div>
                                            <div class="li">
                                                13.3. Использование аналитических cookie не связано с обработкой персональных
                                                данных, позволяющих идентифицировать Пользователя.
                                            </div>
                                            <div class="li">
                                                13.4. Пользователь может ограничить или отключить использование cookie
